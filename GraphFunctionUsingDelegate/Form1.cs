...
namespace GraphFunctionUsingDelegate
{
    public partial class Form1 : Form
    {
        ...
        // Initialize the delegate for the function to draw
        private delegate float FunctionDelegate(float x);

        // Function we're currently drawing
        private FunctionDelegate TheFunction;

        // Select the 1st equation
        private void Form1_Load(object sender, EventArgs e)
        {
            equationComboBox.SelectedIndex = 0;
        }

        // Draw the equation that is being currently selected
        ...
        // y = Ax^6 + Bx^5 + Cx^4 + Dx^3 + Ex^2 + Fx + G. Statement Lambda
        ...
        private void equationComboBox_SelectedIndexChanged_1(object sender, EventArgs e)
        {
